...
class LessonTestCase(APITestCase):
    ...
    def setUp(self):
        ...
        self.course = Course.objects.create(name='Курс математики', description='Базовый курс математики')
        self.lesson = Lesson.objects.create(name='алгебра', description='урок алгебры', owner=self.user,
                                            course=self.course)
